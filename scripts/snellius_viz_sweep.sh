...
#
# Output: results/viz/beta_pmax/{hash}_{seed:06d}_frames.npz
#
...
mkdir -p logs results/viz/beta_pmax
...
uv run spatcoop viz-sweep \
    ...
    --out-dir results/viz/beta_pmax

echo "[viz_sweep] Done: $(date)"
echo ""
echo "Frames in results/viz/beta_pmax/"
